...
\homepage{cs.nyu.edu/~apanda}                         % optional, remove / comment the line if not wanted
...
\cvlistitem{Wen Zhang. PhD student unoffically co-advised with Scott Shenker (UC Berkeley, Fall 2018 -- present)}
...
\cvlistitem{Ioanna Tzialla. PhD student unofficially co-advised with Michael Walfish (Fall 2020 -- Fall 2022)}
...
\cvlistitem{Hugo Sadok. PhD student unofficially co-advised with Justine Sherry (CMU, Fall 2020 -- present)}
...
\cvlistitem{Emily Marx. PhD student unofficially co-advised with Scott Shenker (UC Berkeley, Fall 2022 -- present)}
...
present)}
\cvlistitem{Qiutong Men. Undergraduate student (Fall 2022 -- Spring 2024); PhD
student (Fall 2024 -- present)}
