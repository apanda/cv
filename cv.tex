...
\cvlistitem {Network Consistency Models, applies the CAP theorem to SDN networks, and analyzes consistency requirements for common
network policies.}

\cvlistitem {Data Driven Connectivity, built an online algorithm, based on a result by Gafni-Bertsekas, that ensures perfect connectivity in the face of arbitrary link failures at line rate.}
...
\cvlistitem {Cayman, scheduling for sampling based jobs. Jobs using samples have additional flexibility in terms of several equivalent but not identical versions of data
